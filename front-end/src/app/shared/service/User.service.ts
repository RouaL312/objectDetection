...
export class UserService {
  ...
  addUser(user: User): Observable<string> {
    return this.http.post<string>(this.baseUrl + '/auth/register', user, this.httpOptions);
  }
  updateUser(user: User): Observable<string> {
    return this.http.post<string>(this.baseUrl + '/api/user/update', user, this.httpOptions);
  }
